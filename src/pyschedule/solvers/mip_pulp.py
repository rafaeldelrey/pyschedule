...
__doc__ = """ a simple interface to pulp which is also an interface blueprint
for potential other mip-interfaces """
...
class MIP:
	...
	def __init__(self,name,kind='Minimize'):
		...
		self.mip = pl.LpProblem('IntegerProgram', kinds[kind])
